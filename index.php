...
<script type="text/javascript"> 
 $(document).ready(function(){    	
    				              sweetAlert("Voting Mistake...", "You have not selected your state. Try again !", "error");     				              
                               });       
                    </script>
   <?php  
...
<script type="text/javascript"> 
 $(document).ready(function(){    	
    				              sweetAlert("Voting Mistake...", "Please, tick one party you want to vote for. Try again !", "error");     				              
                               });       
                    </script>
   <?php  
   ...
   <?php if(!(isset($_SESSION['sweetalertOK'])) && !isset($_SESSION['sweetalertError2']) && !isset($_SESSION['sweetalertError1'])){?>
<script type="text/javascript"> 
           $(document).ready(function(){ 
                           var myValue = "Load";
                           swal({
